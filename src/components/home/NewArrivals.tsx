...
const NewArrivals = () => {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="py-16 bg-gradient-to-b from-transparent to-gray-50 dark:to-gray-900/50 animate-on-scroll"
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="section-title text-3xl font-bold">New Arrivals</h2>
          <Link 
            to="/new-arrivals" 
